...
class RedisServiceImpl : RedisService {
    ...
    override fun lRemove(key: String, time: Long, value: Any): Long? {
        return redisTemplate.opsForList().remove(key, time, value)
    }

    override fun countKey(keyPrefix: String): Int {
